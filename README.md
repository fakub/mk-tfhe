...
cmake ../src -DCMAKE_INSTALL_PREFIX=../bin -DENABLE_TESTS=on -DENABLE_FFTW=off -DENABLE_SPQLIOS_AVX=off -DENABLE_SPQLIOS_FMA=off -DENABLE_NAYUKI_PORTABLE=on -DENABLE_NAYUKI_AVX=off -DCMAKE_BUILD_TYPE=debug
make
```
